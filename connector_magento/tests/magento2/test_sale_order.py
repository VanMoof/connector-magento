    ...
    def test_cancel_export(self):
        ...
        with recorder.use_cassette(
            ...
            self.assertEqual(
                ...
                'http://magento.tulpa.nl/index.php/rest/V1/orders/12')
            self.assertEqual(
                cassette.requests[1].uri,
                'http://magento.tulpa.nl/index.php/rest/V1/orders')
            self.assertEqual(
                cassette.requests[2].uri,
                'http://magento.tulpa.nl/index.php/rest/V1/orders/12/comments')
